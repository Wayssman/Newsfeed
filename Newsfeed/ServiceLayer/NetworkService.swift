...
class NetworkService {
    ...
    func doTask(session: URLSession, with url: URL, completion: @escaping (DataTaskResult) -> Void) -> URLSessionDataTask {
    ...
    func loadNews(completion: @escaping (LoadResult) -> Void) {
        ...
        let apiKey = "UCy2HZhT0pkEstci5dIYxLjA2Oj1PfLP"
        ...
        self.doTask(session: session, with: urlConstructor.url!, completion: { result in
            switch result {
